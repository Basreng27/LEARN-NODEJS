...
import { createManyTestBookmarks, createTestBookmark, createTestComic, createTestGenre, createTestUser, getTestBookmark, removeTestBookmark, removeTestComic, removeTestGenre, removeTestUser } from './test-utils.js'
...
describe('DELETE /api/comic/bookmark/:id', () => {
    ...
    it('should can delete', async () => {
        let testBookmark = await getTestBookmark();
        const result = await supertest(web)
        ...
        testBookmark = await getTestBookmark();
        expect(testBookmark).toBeNull();
    })
